...
# Problem 12
# Research to find the Python method that allows you to add an element to the end of the array (similar to push() in JavaScript), 
# then add a name to the end of the `friends` array.
friends.append('Rodney')
print(friends)
...
number_of_ele = len(friends)
print('number of elements in the list: ', number_of_ele)
...
friends.insert(2, 'yeehaw')
print(friends)

# Problem 15
# Remove the last item in the array (try to think about how you can do this dynamically, meaning, if the array contents were to change, 
